                            ...
                            <VStack spacing={1} align="stretch">
                              {availableFiles.map((file, index) => (
                                <Box
                                  key={index}
                                  p={3}
                                  bg={selectedFile?.name === file.name ? selectedFileBg : fileBg}
                                  borderRadius="md"
                                  cursor="pointer"
                                  border="1px"
                                  borderColor={selectedFile?.name === file.name ? 'green.400' : 'transparent'}
                                  _hover={{ 
                                    borderColor: selectedFile?.name === file.name ? 'green.500' : 'blue.200',
                                ...
                                >
                                  <Flex align="center" gap={2}>
                                    ...
                                    {selectedFile?.name === file.name && (
                                      <CheckCircle size={16} color={useColorModeValue('#16a34a', '#22c55e')} />
                                    )}
                                  </Flex>
                                </Box>
                              ))}
